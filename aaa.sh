#!/bin/bash
#SBATCH --job-name=aaa.sh
#SBATCH --output=C:\Users\montie01\Desktop\GIT\thestarsoft2/log.out
...
FAKE=/gpfs/data/denizlab/Users/montie01/T2/JOBS/9000296SAG_T2_MAP_RIGHT
rm -rf $FAKE
...
_DB=/gpfs/home/montie01/PROJECTS/T2/thestarsoft2/db/VA23_Knee_7ETL_10TE.matt
